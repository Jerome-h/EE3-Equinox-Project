 ...
 */
const int logFrequency = 5;       // Enter how often measurments should be taken (in seconds)
...
/* Program that user will not have to change unless mot using a preset sensor
 * 
 */
...
void loop() {
  ...
  if(secondNow % logFrequency == 0){
    logSensorMeasurements(now);
  }
  delay(1000);
...
void logSensorMeasurements(DateTime now){
